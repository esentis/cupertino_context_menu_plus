...
void main() {
  ...
  testWidgets('Pushing a new route removes overlay', (
    WidgetTester tester,
  ) async {
    final Widget child = getChild();
    const page = 'Page 2';
            ...
            return Center(
              child: CupertinoContextMenu(
                actions: const <Widget>[
                  CupertinoContextMenuAction(child: Text('Test')),
                ],
                child: GestureDetector(
                  onTap: () {
  ...
  group('CupertinoContextMenu sheet shrink animation alignment - ', () {
    Future<void> testShrinkAlignment({
      ...
      // Open the CupertinoContextMenu.
      final Rect childRect = tester.getRect(find.byWidget(child));
      final TestGesture openGesture = await tester.startGesture(
        childRect.center,
      );
      await tester.pumpAndSettle();
  ...
  testWidgets(
    'CupertinoContextMenu respects available screen width - Portrait',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'CupertinoContextMenu respects available screen width - Landscape',
    (WidgetTester tester) async {
  ...
  testWidgets('CupertinoContextMenu does not crash at zero area', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      CupertinoApp(
